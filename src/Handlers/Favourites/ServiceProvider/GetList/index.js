...
// managers
const FavouriteSPManager = require(NODE_ENV === 'test' ? "../../../../ManagersLayer/Managers/FavouriteSPManager" : "/opt/FavouriteSPManager");
const ServiceProvidersManager = require(NODE_ENV === 'test' ? "../../../../ManagersLayer/Managers/ServiceProvidersManager" : "/opt/ServiceProvidersManager");
...
module.exports.handler = async (event, context, callback) => {
  try {
    ...
    let procssedList = await ServiceProvidersManager.getFilteredSPList(
      filter,
      cognitoUser,
      FavouriteSPManager.getFullFavouritesSPList
    );
